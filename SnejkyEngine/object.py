...
class Object:
    ...
    def isRayInRadius(self, ray):
        ...
        #D = - c1*c1*u2*u2 - c1*c1*u3*u3 + 2*c1*c2*u1*u2 + 2*c1*c3*u1*u3 + 2*c1*s1*u2*u2 +
        #  2*c1*s1*u3*u3 - 2*c1*s2*u1*u2 - 2*c1*s3*u1*u3 - c2*c2*u1*u1 - c2*c2*u3*u3 + 2*c2*c3*u2*u3
        #  - 2*c2*s1*u1*u2 + 2*c2*s2*u1*u1 + 2*c2*s2*u3*u3 - 2*c2*s3*u2*u3 - c3*c3*u1*u1 - 
        # c3*c3*u2*u1 - 2*c3*s1*u1*u3 - 2*c3*s2*u2*u3 + 2*c3*s3*u1*u1 + 2*c3*s3*u2*u2 + 
        # r*r*u1*u1 + r*r*u2*u2 + r*r*u3*u3 - s1*s1*u2*u2 - s1*s1*u3*u3 + 2*s1*s2*u1*u2 +
        #  2*s1*s3*u1*u3 - s2*s2*u1*u1 - s2*s2*u3*u3 + 2*s2*s3*u2*u3 - s3*s3*u1*u1 - s3*s3*u2*u2
