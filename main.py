...
triangles = (NUM_TYPE * TRIANGLE_SIZE)(10,0,10, # vertex 1
                                        10,-10,-10, # vertex 2
                                        10,10,-10, # vertex 3
                                        25,25,0) # colors                     
...
for y in range(SCREEN_HEIGHT):
    for x in range(SCREEN_WIDTH):
        ...
        color = RAY_SHOOT(screen_pos, camera_pos, camera_dir, 
                ...
                triangles, triangles_count)
        if (color < 0): 
            img.putpixel((x, SCREEN_HEIGHT - y - 1), (255, 255, 255))
            continue
        #print(x, y, color)
        byte_arr = struct.pack("<I", color)
        img.putpixel((x, SCREEN_HEIGHT - y - 1), (byte_arr[0], byte_arr[1], byte_arr[2]))
